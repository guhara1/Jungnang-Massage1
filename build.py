...
<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-col footer-about">
      ...
      <p class="footer-desc">중랑구 전지역 방문 출장마사지·홈타이 예약 안내 사이트입니다. 위생·안전 기준 안에서만 운영합니다.</p>
      ...
      <div class="footer-cta">
        <a class="footer-cta-btn" href="{TELEGRAM_URL}" target="_blank" rel="noopener nofollow">
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21.94 4.66a1 1 0 0 0-1.06-.16L3.3 11.7c-.86.35-.82 1.6.06 1.9l4.34 1.45 1.64 5.02c.26.8 1.3.96 1.79.28l2.4-3.3 4.55 3.35c.6.44 1.46.12 1.62-.6l2.9-13.6a1 1 0 0 0-.36-1Zm-3.9 3.1-7.2 6.55a.9.9 0 0 0-.28.5l-.36 2.2-1.18-3.6 9-5.9c.3-.2.6.2.32.45Z"/></svg>
          웹사이트 제작문의
        </a>
        <a class="footer-cta-btn" href="{TELEGRAM_URL}" target="_blank" rel="noopener nofollow">
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21.94 4.66a1 1 0 0 0-1.06-.16L3.3 11.7c-.86.35-.82 1.6.06 1.9l4.34 1.45 1.64 5.02c.26.8 1.3.96 1.79.28l2.4-3.3 4.55 3.35c.6.44 1.46.12 1.62-.6l2.9-13.6a1 1 0 0 0-.36-1Zm-3.9 3.1-7.2 6.55a.9.9 0 0 0-.28.5l-.36 2.2-1.18-3.6 9-5.9c.3-.2.6.2.32.45Z"/></svg>
    ...
    <nav class="footer-col" aria-label="서비스 안내">
      ...
      <ul>
        ...
        <li><a href="/seoul/jungnang-gu/">지역별 안내</a></li>
        <li><a href="/seoul/jungnang-gu/station/">역세권 안내</a></li>
        <li><a href="/seoul/jungnang-gu/area/">생활권 안내</a></li>
